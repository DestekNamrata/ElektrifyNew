...
import '/src/components/delivery_day_item.dart';
import '/src/components/delivery_time_item.dart';
                            ...
                            children:
                              ...
                              return InkWell(
                                child: DeliveryTimeItem(
                                  date: "${shopController.deliveryDate}",
                                  time: time,
                                  color: Get.isDarkMode
                                      ? Color.fromRGBO(130, 139, 150, 1)
                                      : Color.fromRGBO(136, 136, 126, 1),
