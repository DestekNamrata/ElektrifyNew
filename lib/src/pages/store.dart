...
import '/src/components/custom_btn.dart';
import '/src/components/search_input.dart';
import '/src/components/shop_list_horizontal.dart';
import '/src/components/shop_list_vertical.dart';
import '/src/components/tab_button.dart';
              ...
              child: BackdropFilter(
                ...
                child: Container(
                  ...
                  padding: const EdgeInsets.only(
                      top: 18, bottom: 22, left: 28, right: 43),
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      Obx(() => Container(
