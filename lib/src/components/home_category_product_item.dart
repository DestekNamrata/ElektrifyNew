...
import '/src/components/count_down_time.dart';
import '/src/controllers/product_controller.dart';
import '/src/models/product.dart';

class HomeCategoryProductItem extends GetView<ProductController> {
  final Product? product;
  final bool? iSimilar;

  HomeCategoryProductItem({this.product, this.iSimilar = false});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      width: 170,
      margin: EdgeInsets.only(right: 8, bottom: height ? 0 : 49),
