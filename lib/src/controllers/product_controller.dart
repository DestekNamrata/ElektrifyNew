...
import '/src/requests/product_comment_request.dart';
import '/src/requests/product_extras_request.dart';
...
class ProductController extends GetxController {
  ...
  var rangeStartPrice = RxDouble(0);
  var rangeEndPrice = RxDouble(10000);
  var sortType = 0.obs;
  var searchText = "".obs;
