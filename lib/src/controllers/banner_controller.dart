...
import '/src/models/banner.dart';
import '/src/models/product.dart';
import '/src/models/shop.dart';
import '/src/requests/banners_products_request.dart';
import '/src/requests/banners_request.dart';
          ...
          if (index == -1)
            bannerProductList.add(Product(
              ...
              isCountDown: item['product']['discount'] != null
                  ? int.parse(
                      item['product']['discount']['is_count_down'].toString())
                  : 0,
              ...
              discount: item['product']['discount'] != null
                  ? double.parse(
                      item['product']['discount']['discount_amount'].toString())
                  : 0,
              discountType: item['product']['discount'] != null
                  ? int.parse(
                      item['product']['discount']['discount_type'].toString())
                  : 0,
              id: id,
